...
<body>
  ...
  if(isset($_POST['submit'])){
    if(!empty($_POST['name']) && !empty($_POST['phone']) && !empty($_POST['email'])){
      ...
      $db->addNote($_POST['name'],$_POST['phone'],$_POST['email'], $_SESSION['user_id'], $img_name);
        ...
        <div class="d-flex justify-content-center form_container">
          <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="input-group mb-2">
              ...
              <input type="tel" name="phone" class="form-control input_user" value="" placeholder="phone">
            </div>
            <div class="input-group mb-2">
              <div class="input-group-append">
            ...
            <div class="input-group mb-2">
              ...
              <input type="file" name="image" class="form-control input_user" accept="image/*">
            </div>
